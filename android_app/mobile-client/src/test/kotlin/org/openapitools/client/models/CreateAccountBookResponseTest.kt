...
class CreateAccountBookResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateAccountBookResponse
        //val modelInstance = CreateAccountBookResponse()
